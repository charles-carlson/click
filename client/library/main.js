...
export default class MainScreen extends Component {
    ...
    async componentDidMount(){
        fetch('http://INSERT_IP_HERE:3001/score/getScore').then(res=>{
            return res.json()
            .then(myjson=>{
        ...
        fetch('INSERT_IP_HERE:3001/money/getMoney').then(res=>{
            return res.json()
        }).then(myjson=>{
    ...
    handlePress(){
            fetch('http://INSERT_IP_HERE:3001/score/increase',{
                method:'PUT',
                headers:{
                    'Content-Length': '0'
                   }
                    ...
                    if(this.state.score % 15 == 0){
                        ...
                        fetch('http://INSERT_IP_HERE:3001/money/deposit',{
                            method:'PUT',
                            headers:{
                                'Content-Length': '0'
                               }
